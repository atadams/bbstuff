                ...
                for i, pitch in enumerate(pitches):
                    ...
                    if at_bat_id != pitch.at_bat.id:
                        ...
                        if display_matchup_block:
                            ...
                            vs_image = text_image('vs', height=pitcher_name_image.height)
                            ...
                            image_width = batter_name_x + batter_name_clip.w

                            matchup_video = CompositeVideoClip(
                                size=(image_width, pitcher_name_image.height),
                                clips=[
                                    pitcher_name_clip.set_opacity(0.9).set_position((10, 0)),
                                    vs_clip.set_opacity(0.9).set_position((vs_clip_x, 0)),
                                    batter_name_clip.set_opacity(0.9).set_position((batter_name_x, 0)),
                                ],
                            )

                    if matchup_video:
                        video_elements.append(matchup_video.set_position((5, 5)))
                    ...
                    #
                    #     video_elements.append(count_clip)
